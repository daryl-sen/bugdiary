...
Revision ID: 819922bdcd73
Revises: 
Create Date: 2020-10-07 05:14:50.377582
...
def upgrade():
    ...
    sa.Column('bug_location', sa.String(length=100), nullable=True),
    sa.Column('bug_type', sa.String(length=100), nullable=True),
    sa.Column('project', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['project'], ['projects.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_bugs_bug_location'), 'bugs', ['bug_location'], unique=False)
    ...
    sa.Column('menu_color', sa.String(length=7), nullable=True),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_bugs_bug_location'), table_name='bugs')
    op.drop_table('bugs')
